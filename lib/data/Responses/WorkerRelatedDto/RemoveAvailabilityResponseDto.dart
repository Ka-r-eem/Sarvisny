...
class RemoveAvailabilityResponseDto {
  RemoveAvailabilityResponseDto({
      this.status, 
      this.isError, 
      this.message, 
      this.errors, 
  ...
  RemoveAvailabilityResponseDto.fromJson(dynamic json) {
    status = json['status'];
    ...
    payload = json['payload'] != null ? providerDataDto.fromJson(json['payload']) : null;
  }
  dynamic status;
  bool? isError;
  String? message;
  List<dynamic>? errors;
  providerDataDto? payload;
RemoveAvailabilityResponseDto copyWith({  dynamic status,
  bool? isError,
  String? message,
  List<dynamic>? errors,
  providerDataDto? payload,
}) => RemoveAvailabilityResponseDto(  status: status ?? this.status,
  ...
  RemoveAvailabilityResponse toRemoveAvailabilityResponse() => RemoveAvailabilityResponse(
    status: status,
    isError: isError,
    message: message,
    errors: errors,
    payload: payload?.toProviderData(),
  );
...
class providerDataDto {
  ...
  providerDataDto.fromJson(dynamic json) {
  ...
  String? dayOfWeek;
  List<SlotsDto>? slots;
providerDataDto copyWith({  String? providerAvailabilityID,
  String? serviceProviderID,
  String? dayOfWeek,
  List<SlotsDto>? slots,
}) => providerDataDto(  providerAvailabilityID: providerAvailabilityID ?? this.providerAvailabilityID,
  ...
  providerData toProviderData() => providerData(
    providerAvailabilityID: providerAvailabilityID,
    serviceProviderID: serviceProviderID,
    dayOfWeek: dayOfWeek,
    slots: slots?.map((v) => v.toSlots()).toList(),
  );
...
SlotsDto copyWith({  String? timeSlotID,
  String? startTime,
  String? endTime,
  bool? isActive,
  String? providerAvailabilityID,
  dynamic providerAvailability,
}) => SlotsDto(  timeSlotID: timeSlotID ?? this.timeSlotID,
