...
class WorkerRegisteredServicesResponseDto {
  WorkerRegisteredServicesResponseDto({
    this.status,
    this.isError,
    this.message,
    this.errors,
  ...
  WorkerRegisteredServicesResponseDto.fromJson(dynamic json) {
    status = json['status'];
    ...
    if (json['payload'] != null) {
      ...
      json['payload'].forEach((v) {
        payload?.add(RegisteredServiceDto.fromJson(v));
      });
    }
  }
  ...
  String? message;
  List<Error>? errors;
  List<RegisteredServiceDto>? payload;

  WorkerRegisteredServicesResponseDto copyWith({
    String? status,
    bool? isError,
    String? message,
    List<Error>? errors,
  ...
  WorkerRegisteredServicesResponse toResponse(){
    return WorkerRegisteredServicesResponse(
      status: status,
      message: message,
      isError: isError,
...
class RegisteredServiceDto {
  ...
  RegisteredServiceDto.fromJson(dynamic json) {
