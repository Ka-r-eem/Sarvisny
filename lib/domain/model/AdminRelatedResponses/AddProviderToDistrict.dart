...
class AddProviderToDistrict {
  ...
  AddProviderToDistrict.fromJson(dynamic json) {
    status = json['status'];
...
AddProviderToDistrict copyWith({  String? status,
  bool? isError,
  String? message,
  List<dynamic>? errors,
  ProviderDistrict? payload,
}) => AddProviderToDistrict(  status: status ?? this.status,
